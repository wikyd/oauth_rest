...
GEMSPEC = Gem::Specification.new do |s|
  ...
  s.summary = "A library for accessing REST APIs using OAuth.  Translates Ruby method calls into REST requests."
  s.description = s.summary
  s.author = "Kyle Wilkinson"
  s.email = "kai@wikyd.org"
  s.homepage = "http://github.com/wikyd/oauth_rest"
